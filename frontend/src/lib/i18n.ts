...
export const translations = {
  en: {
    ...
    infoBestTier: 'Which prediction type you nail most often. Counted only on finished matches with ≥3 attempts per tier. Example: if you predicted BTTS 10 times and got it right 7 times, that\'s a 70% hit rate.',
    infoCoinROI: 'How efficiently your coins perform across all resolved predictions. Formula: (coins returned ÷ coins staked) × 100. Above 100% = profitable. Each prediction stakes coins equal to the tiers you bet on; when a match resolves you receive points × 2 coins back.',
    infoBestMatch: 'Your highest-scoring match ever. Max possible is 19 pts (Result 3 + Exact Score 7 + Corners 4 + BTTS 2 + Over/Under 3). A perfect match means you nailed every single tier.',
    tierResult: 'Result',
  ...
  he: {
    ...
    bestTier: 'טייר מוביל',
    coinROI: 'תשואת מטבעות',
    bestMatch: 'המשחק הטוב',
    infoBestTier: 'איזה סוג ניבוי אתה מנחש הכי טוב. נחשב רק במשחקים שנגמרו עם לפחות 3 ניסיונות לטייר. לדוגמה: ניחשת BTTS 10 פעמים, צדקת 7 פעמים = 70% הצלחה.',
    infoCoinROI: 'כמה יעילים המטבעות שלך. נוסחה: (מטבעות שחזרו ÷ מטבעות שהוימרו) × 100. מעל 100% = רווחי. בכל ניבוי אתה מהמר מטבעות לפי הטיירים שבחרת; כשמשחק נפתר אתה מקבל נקודות × 2 בחזרה.',
    infoBestMatch: 'המשחק שבו ניקדת הכי הרבה. מקסימום אפשרי: 19 נק׳ (תוצאה 3 + מדויק 7 + קרנות 4 + שתיים מבקיעות 2 + מעל/מתחת 3). משחק מושלם = פגעת בכל 5 הטיירים.',
    tierResult: 'תוצאה',
    tierScore: 'מדויק',
    tierCorners: 'קרנות',
