...
export const translations = {
  en: {
    ...
    parlaySlipTitle: 'My Parlay Slip',
    parlaySlipArmed: 'Parlay armed',
    parlaySlipLock: 'Lock In Parlay',
    parlayUnlink: 'Remove from parlay',
    parlayHintLabel: 'Chain tiers for a bonus',
    parlayHintDetail: 'Tap 🔗 on 2-3 tiers to chain them — free, no extra coins. If ALL linked tiers hit, you get a bonus (x1.25 for 2 tiers, x1.5 for 3) on top of their points. If even one misses, you lose only the bonus — every tier still scores its own points normally either way. Bonus points also convert to coins at the usual 2x rate.',
    parlaySlipDrawerHint: 'Free to chain. Bonus pays only if every linked tier is correct — a miss costs you the bonus, never your other tiers\' points.',
    ...
    momentumResolvesExplainer: 'The result checks the full 10-minute window when the timer ends — not the instant a goal happens. A goal now still counts, just wait for the timer.',
    attackPulseLabel: 'Attack Pulse',
    attackPulseWindow: 'last {0} min',
    attackPulseExplainer: 'A circle = goal, a square = card, placed at the minute it happened. Top row = home team, bottom row = away team. Brighter = more recent.',
    pressureFlowTitle: 'Pressure Meter',
    pressureFlowSubtitle: 'Attacking Momentum',
    pressureFlowExplainer: 'Tilts toward whichever team is applying more pressure right now (shots, corners, possession) — not who\'s winning. A flat middle line means no clear pressure either way.',
    pressureFlowGathering: 'Gathering data…',
    ...
    oracleNoDataDial: 'N/A',
    oracleNoRecentData: 'No recent matches on record',
    ...
    poolContributionRow: 'Shared Pool Contribution',
    poolWonRow: 'Shared Pool Payout',
    cosmeticPurchaseRow: 'Cosmetic Purchase',
    ...
    // V5 Sprint 36 Hotfix — pool/battle creation entry points
    startSharedPool: 'Start a Shared Pool',
    poolCreateSuccess: 'Pool started — invite your group to pile in!',
    poolCreateErrorLocked: 'Too close to kickoff to start a pool',
    poolCreateErrorInvalidPrediction: 'Pick a result or exact score first',
    poolCreateErrorAlreadyExists: 'This match already has a pool',
    poolCreateErrorGeneric: 'Could not start the pool',
    poolCreateErrorTimeout: 'Taking too long — check your connection and try again',
    poolCreating: 'Starting…',
    poolCreatedConfirmed: 'Pool Started',
    challengeAGroup: 'Challenge a Rival Group',
    challengeGroupTitle: 'Challenge a Group',
    challengeGroupDesc: "Enter a rival group's invite code and pick a battle length",
    rivalInviteCode: "Rival Group's Invite Code",
    rivalInviteCodePlaceholder: 'e.g. AB12CD',
    battleDuration: 'Battle Duration',
    battleDurationWeekend: 'Weekend (3 days)',
    battleDurationWeek: '7-Day Battle',
    sendChallenge: 'Send Challenge',
    battleChallengeSent: 'Challenge sent — waiting for their response!',
  ...
  he: {
    ...
    setupStep1: '1. צור פרויקט חינמי ב-supabase.com',
    setupStep2: '2. הרץ את 3 קבצי ה-SQL במעבד השאילתות',
    setupStep3: '3. הפעל Google OAuth ב-Authentication → Providers',
    setupStep4: '4. החלף את .env.local ב-URL ומפתח ה-anon האמיתיים שלך מ-Supabase',
    ...
    noLeaderboardDesc: 'תתחיל לנחש משחקים כדי להופיע בטבלה.',
    ...
    infoPredictions: 'סה"כ ניחושים שעשית. "נפתרו" = המשחק הסתיים והנקודות חושבו.',
    ...
    infoRecentForm: '5 המשחקים האחרונים שנגמרו שבהם ניחשת את תוצאת 90 הדקות (ניצחון בית / תיקו / ניצחון חוץ). ירוק = צדקת, אדום = טעית. המספר מראה רצף הצלחות נוכחי.',
    tierResult: 'תוצאה',
    tierScore: 'מדויק',
    tierCorners: 'קרנות',
    ...
    resetScoresDesc: 'מאפס את כל הנקודות והסטטיסטיקות של כולם בקבוצה. היסטוריית הניחושים נשמרת.',
    ...
    cornersUnsupportedTooltip: 'סטטיסטיקה זו אינה נתמכת במשחק הזה',
    parlayChainToggle: 'שרשור לשילוב',
    parlayChainToggleDisabled: 'נחשו את הטייר הזה קודם כדי לשרשר',
    parlaySlipTitle: 'כרטיס השילוב שלי',
    parlaySlipArmed: 'השילוב נעול',
    parlaySlipLock: 'נעילת השילוב',
    parlayUnlink: 'הסרה מהשילוב',
    parlayHintLabel: 'שרשור טיירים לבונוס',
    parlayHintDetail: 'לחצו על 🔗 ב-2-3 טיירים כדי לשרשר אותם — בחינם, בלי מטבעות נוספים. אם כל הטיירים המשורשרים יוצאים נכון, מקבלים בונוס נקודות (פי 1.25 לשני טיירים, פי 1.5 לשלושה) בנוסף לנקודות שלהם. אם אפילו אחד מפספס, מפסידים רק את הבונוס — כל טייר עדיין מרוויח את הנקודות שלו כרגיל בכל מקרה. גם נקודות הבונוס הופכות למטבעות ביחס הרגיל של פי 2.',
    parlaySlipDrawerHint: 'שרשור חינמי. הבונוס משולם רק אם כל הטיירים המשורשרים יצאו נכון — פספוס עולה רק בבונוס, לעולם לא בנקודות של הטיירים האחרים.',
    streakTooltip: 'רצף של {0} ניחושים נכונים',
    ...
    tiltFailedToast: 'לא הצלחנו להפעיל הטיה',
    ...
    leaveGroupConfirm: 'בטוח שאתה רוצה לעזוב את הקבוצה?',
    ...
    syncDesc: 'מביא לוח משחקים מעודכן',
    change: 'שנה',
    ...
    momentumSubtitle: 'הזמן אוזל — נחשו מהר!',
    ...
    momentumFailedToast: 'לא הצלחנו לשמור את הניחוש',
    ...
    momentumResolvesExplainer: 'התוצאה נבדקת על כל חלון 10 הדקות כשהטיימר מסתיים — לא ברגע שהשער נכנס. שער עכשיו עדיין נספר, פשוט חכו לטיימר.',
    attackPulseLabel: 'דופק התקפה',
    attackPulseWindow: 'ב-{0} הדקות האחרונות',
    attackPulseExplainer: 'עיגול = שער, ריבוע = כרטיס, ממוקם בדקה שבה זה קרה. שורה עליונה = קבוצת הבית, שורה תחתונה = קבוצת החוץ. בהיר יותר = קרוב יותר לעכשיו.',
    pressureFlowTitle: 'מד לחץ משחק',
    pressureFlowSubtitle: 'מומנטום התקפי',
    pressureFlowExplainer: 'נוטה לכיוון הקבוצה שמפעילה יותר לחץ כרגע (בעיטות, קרנות, אחזקת כדור) — לא מי שמנצחת. קו אמצע שטוח אומר שאין לחץ ברור לאף צד.',
    pressureFlowGathering: 'אוסף נתונים…',
    oracleTitle: 'האורקל',
    ...
    oracleNoDataDial: 'אין נתונים',
    oracleNoRecentData: 'אין עדיין מספיק משחקים אחרונים',
    ...
    poolContributionRow: 'תרומה לקופה משותפת',
    poolWonRow: 'זכייה בקופה משותפת',
    cosmeticPurchaseRow: 'רכישת פריט יוקרה',
    emptyLedger: 'אין לך עדיין תנועות',
    ...
    wcNationsMarch: '48 נבחרות, דרך אחת',
    wcScrollHint: 'גלול ←',
    wcMatch: 'משחק',
    ...
    arenaLoadFailed: 'לא הצלחנו לטעון את נתוני הזירה',
    ...
    trophyParlayMasterDesc: '3+ שילובים באותו משחק',
    ...
    poolDecreaseStake: 'הפחת תרומה',
    poolIncreaseStake: 'הגדל תרומה',
    poolJoinPool: 'הצטרף לקופה',
    poolUpdateStake: 'עדכן תרומה',
    ...
    poolErrorGeneric: 'לא הצלחנו לעדכן את התרומה',
    ...
    battleErrorGeneric: 'לא הצלחנו להגיב לאתגר',
    activityBattleStarted: 'הקרב התחיל! ⚔️',
    activityBattleFinal: 'הקרב הסתיים!',

    // V5 Sprint 36 Hotfix — נקודות כניסה ליצירת קופה/קרב
    startSharedPool: 'התחל קופה משותפת',
    poolCreateSuccess: 'הקופה נפתחה — הזמינו את הקבוצה להצטרף!',
    poolCreateErrorLocked: 'קרוב מדי לפתיחה כדי לפתוח קופה',
    poolCreateErrorInvalidPrediction: 'בחרו קודם תוצאה או תוצאה מדויקת',
    poolCreateErrorAlreadyExists: 'למשחק הזה כבר יש קופה',
    poolCreateErrorGeneric: 'לא הצלחנו לפתוח את הקופה',
    poolCreateErrorTimeout: 'לוקח יותר מדי זמן — בדקו את החיבור ונסו שוב',
    poolCreating: 'פותח...',
    poolCreatedConfirmed: 'הקופה נפתחה',
    challengeAGroup: 'אתגר קבוצה יריבה',
    challengeGroupTitle: 'אתגור קבוצה',
    challengeGroupDesc: 'הזינו קוד הזמנה של קבוצה יריבה ובחרו את משך הקרב',
    rivalInviteCode: 'קוד ההזמנה של הקבוצה היריבה',
    rivalInviteCodePlaceholder: 'לדוגמה AB12CD',
    battleDuration: 'משך הקרב',
    battleDurationWeekend: 'סוף שבוע (3 ימים)',
    battleDurationWeek: 'שבוע (7 ימים)',
    sendChallenge: 'שלח אתגר',
    battleChallengeSent: 'האתגר נשלח — ממתינים לתשובה!',
    ...
    prestigeShopSubtitle: 'התשלום ירד מהיתרה של {0}',
    slotFrame: 'מסגרות',
    slotHalo: 'הילות',
    slotBadge: 'תגי יוקרה',
    cosmeticBuy: 'קנה',
    cosmeticEquip: 'צייד',
    cosmeticUnequip: 'הסר',
    cosmeticPurchaseSuccess: 'נפתח! לחצו על "צייד" כדי לענוד את זה.',
    cosmeticEquipSuccess: 'צויד!',
    cosmeticUnequipSuccess: 'הוסר',
    cosmeticErrorGeneric: 'לא הצלחנו לבצע את הפעולה',
