...
export const translations = {
  ...
  he: {
    ...
    parlayHintLabel: 'שרשור קטגוריות לבונוס',
    parlayHintDetail: 'לחצו על 🔗 ב-2-3 קטגוריות כדי לשרשר אותן — בחינם, בלי מטבעות נוספים. אם כל הקטגוריות המשורשרות יוצאות נכון, מקבלים בונוס נקודות (פי 1.25 לשתי קטגוריות, פי 1.5 לשלוש) בנוסף לנקודות שלהן. אם אפילו אחת מפספסת, מפסידים רק את הבונוס — כל קטגוריה עדיין מרוויחה את הנקודות שלה כרגיל בכל מקרה. גם נקודות הבונוס הופכות למטבעות ביחס הרגיל של פי 2.',
    parlaySlipDrawerHint: 'שרשור חינמי. הבונוס משולם רק אם כל הקטגוריות המשורשרות יצאו נכון — פספוס עולה רק בבונוס, לעולם לא בנקודות של הקטגוריות האחרות.',
    ...
    oracleNoRecentData: 'אין משחקים אחרונים במאגר',
    ...
    poolCreateErrorGeneric: 'לא ניתן היה לפתוח את הקופה',
    ...
    cosmeticErrorAlreadyUnlocked: 'הפריט הזה כבר ברשותך',
