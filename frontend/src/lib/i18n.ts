...
export const translations = {
  en: {
    ...
    monteCarloTitle: 'Score Simulator',
    monteCarloSubtitle: '50,000 simulations',
    monteCarloTapHint: 'Tap a score to select it',
    ...
    duelStakeRow: 'Live Duel Stake',
    duelWonRow: 'Live Duel Won',
    duelRefundRow: 'Live Duel Refund',
  ...
  he: {
    ...
    monteCarloTitle: 'סימולטור תוצאות',
    monteCarloSubtitle: '50,000 סימולציות',
    monteCarloTapHint: 'הקש על תוצאה לבחירה',
    ...
    duelStakeRow: 'הימור בדו-קרב חי',
    duelWonRow: 'זכייה בדו-קרב חי',
    duelRefundRow: 'החזר מדו-קרב חי',
