...
const EARN_ROWS = [
  {
    ...
    detailHe: 'בכל הצטרפות או פתיחה של קבוצה מקבלים בונוס פתיחה מיידי',
    value: '+120',
  ...
  },
  {
    ...
    detailHe: 'כל יום, בכניסה הראשונה לאפליקציה, מקבלים מטבעות אוטומטית',
    value: '+30 / day',
    valueHe: '+30 / יום',
  ...
  },
  {
    ...
    detailHe: 'כל נקודה שמרוויחים מחזירה 2 מטבעות — כך מי שמנחש טוב צובר יותר',
    value: '×2 per pt',
    valueHe: '×2 לנקודה',
