...
│       │   ├── supabase.ts                # Supabase client (anon key) + all TypeScript table types. V4 Sprint 24 — Profile Row type gains `gender: 'male'|'female'|'unspecified'` (migration 047)
...
Migrations live in `supabase/migrations/`. Current sequence: **001 → 047** (024 does not exist).
